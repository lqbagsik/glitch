...
var mongoose = require('mongoose');
 mongoose.connect(process.env.MONGO_URI="mongodb+srv://lqbagsik:noxide01@cluster0.hpo4c.mongodb.net/<admin>?retryWrites=true&w=majority", { useNewUrlParser: true, useUnifiedTopology: true }); 
...
var createAndSavePerson = function(done) {
  var pimpC = new Person({name: "Pimp C", age: 33, favoriteFoods: ["lean"]});
...
// 'arrayOfPeople'.
var arrayOfPeople = [
  {name: "Janica", age: 62, favoriteFoods: ["pizza", "asparagus"]},
  {name: "Katya", age: 26, favoriteFoods: ["kale", "spinach"]},
  {name: "Veronica", age: 42, favoriteFoods: ["empanada"]}
];
...
var findPersonById = function(personId, done) {
  Person.findById({_id: personId}, function(err, _id){
    if(err){
      done(err);
    }
    done(null, _id);
